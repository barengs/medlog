              ...
              <div class="row">
                  <div class="col-md-4">
                      <div class="mb-3">
                          ...
                          <input type="text" name="kode" placeholder="Tulis Kode Obat" class="form-control" id="basicInput">
                      </div>
                  </div>
                  <div class="col-md-4">
                      <div class="mb-3">
                          ...
                          <input type="text" name="nama" placeholder="Tulis Nama atau merek" class="form-control" id="withHelperText">
                      </div>
                  </div>
              </div>
              <div class="row"> 
                  <div class="col-md-4">
                      <div class="mb-3">
                          ...
                          <input type="text" name="kadaluwarsa" class="form-control date" id="withHelperTextBottom"
                  ...
                  <div class="col-md-4">
                    <div class="mb-3">
                        ...
                        <input type="number" name="stok" placeholder="Tulis Stok Obat" class="form-control" id="basicInput">
                    </div>
                </div>
              </div>
              <div class="row">
                  <div class="col-md-6">
                      <div class="mb-3">
                          ...
                          <textarea class="form-control" name="keterangan" placeholder="tulis infomasi obat" id="exampleFormControlTextarea1" rows="3"></textarea>
                      </div>
                  </div>
              </div>
            </div>
