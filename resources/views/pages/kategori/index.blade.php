    ...
    <div class="main-content">
        <div class="d-flex mx-1 justify-content-between">
            ...
            <nav class="float-end"
                ...
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('kategori.semua') }}">Obat</a></li>
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="btn-group float-end" role="group" aria-label="Basic mixed styles example">
                                {{-- perhatikan disini --}}
                                <a class="btn icon-left btn-primary btn-sm" href="{{ route('kategori.tambah') }}"><i
                                        class="ti-list"></i>Tambah Kategori</a>
