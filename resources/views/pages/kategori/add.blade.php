      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between">
          ...
          <div class="btn-group float-end" role="group" aria-label="Basic mixed styles example">
              <a class="btn icon-left btn-warning btn-sm" href="{{ route('kategori.index') }}"><i class="ti-close"></i>Batal</a>
          </div>
        </div>
          <div class="card-body">
              @csrf
              <div class="row">
                  <div class="col-md-4">
                      <div class="mb-3">
                          ...
                          <input type="text" name="nama" placeholder="Tulis Nama Kategori Obat" class="form-control" id="basicInput">
                      </div>
                  </div>
              </div>
            </div>
