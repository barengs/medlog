      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between">
          ...
          <div class="btn-group float-end" role="group" aria-label="Basic mixed styles example">
              <a class="btn icon-left btn-warning btn-sm" href="{{ route('jabatan.semua') }}"><i class="ti-close"></i>Batal</a>
              ...
              <div class="row">
                  <div class="col-md-4">
                      <div class="mb-3">
                          ...
                          <input type="text" value="{{ $data->nama }}" name="nama" placeholder="Ubah Nama Jabatan" class="form-control" id="basicInput">
                      </div>
                      <div class="mb-3">
                        <label for="status" class="form-label">Nama Jabatan</label>
                        <select id="status" name="status" class="js-example-basic-single form-select">
