                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="btn-group float-end" role="group" aria-label="Basic mixed styles example">
                            {{-- perhatikan disini --}}
                            <a class="btn icon-left btn-primary btn-sm" href="{{ route('jabatan.tambah') }}"><i class="ti-plus"></i>Tambah Jabatan</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <a class="btn icon-left btn-warning btn-sm" href="{{ route('jabatan.ubah', $item->id) }}"><i class="ti-pencil-alt"></i>Ubah</a>
                                                <a class="btn icon-left btn-danger btn-sm" href="{{ route('jabatan.hapus', $item->id) }}"><i class="ti-trash"></i>Hapus</a>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforeach
