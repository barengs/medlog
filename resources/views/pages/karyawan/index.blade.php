                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <div class="btn-group float-end" role="group" aria-label="Basic mixed styles example">
                                {{-- perhatikan disini --}}
                                <a class="btn icon-left btn-primary btn-sm" href="{{ route('karyawan.tambah') }}"><i
                                        class="ti-plus"></i>Tambah Karyawan</a>
                                        ...
                                        @if ($data)
                                            @foreach ($data as $item)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <a class="btn icon-left btn-info btn-sm"
                                                                href="{{ route('karyawan.lihat', $item->id) }}"><i
                                                                    class="ti-eye"></i>Lihat</a>
