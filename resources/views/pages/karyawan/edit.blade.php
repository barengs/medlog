                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $data->profile->nama_depan }}" type="text" name="nama_depan"
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $data->profile->nama_belakang }}" type="text" name="nama_belakang"
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $data->profile->tempat_lahir }}" type="tempat_lahir"
                                        name="tempat_lahir" placeholder="Tulis tempat lahir" class="form-control"
                                        id="basicInput">
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $data->profile->tanggal_lahir }}" type="text" name="tanggal_lahir"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $data->profile->no_handphone }}" type="text" name="no_handphone"
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <select id="status" name="jenis_kelamin" class="js-example-basic-single form-select">
                                        @if ($data->profile->jenis_kelamin == 'pria')
                            ...
                            <div class="col-lg-4">
                                <div class="mb-3">
                                    ...
                                    <input value="{{ $data->profile->no_ktp }}" type="text" name="no_ktp"
                                ...
                                <div class="col-lg-8">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="alamat" placeholder="tulis alamat lengkap" id="exampleFormControlTextarea1"
                                            rows="2">{{ $data->profile->alamat }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="file" value="{{ $data->profile->foto }}" name="foto"
